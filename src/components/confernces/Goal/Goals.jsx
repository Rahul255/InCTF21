...
const EventGoals = () => {
    ...
    const goals = [
        {
            "cover": require('../../../../src/assets/images/conference/covers/Data_security_01.jpg').default,
            "text": "There are a lot of untapped opportunities for people to take up the role of safeguarding a digital space.",
        },
        {
            "cover": require('../../../../src/assets/images/conference/covers/Data_security_02.jpg').default,
        ...
        {
            "cover": require('../../../../src/assets/images/conference/covers/Data_security_03.jpg').default,
        ...
        {
            "cover": require('../../../../src/assets/images/conference/covers/Data_security_04.jpg').default,
