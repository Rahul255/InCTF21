...
const SideBar = ({ onClose, darkenOnSidebar }) => {
    ...
    const sidebarLinks =  [
        ...
        { icon: "fa fa-home mr-2", "title": "Speakers", "href": "/guest_speaker" },
        { icon: "fa fa-home mr-2", "title": "Schedule", "href": "/schedule" },
        { icon: "fa fa-home mr-2", "title": "Sponsors", "href": "/sponsors" },
        { icon: "fa fa-home mr-2", "title": "Promote", "href": "/promote" },
    ];
                ...
                <div className="sidebar-container">
                    <div style={{ position: 'absolute', right: '0.25rem', top: '0.25rem' }}>
                        <button onClick={onClose}>
                            <i style={{ fontSize: '32px' ,paddingRight:'20px'}} className="fa text-light fa-times" />
                        </button>
                    </div>
                    <div className="text-center pt-5">
                        <img alt="ShaktiCon" style={{ maxHeight: '20vh', maxWidth: '100%' }} className="p-3" src={require('../../../../src/assets/images/conference/logomain.png').default} />
                    </div>
