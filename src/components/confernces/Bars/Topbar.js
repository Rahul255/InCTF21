        ...
        <Header ref={topbarRef}>
            <div className="row w-100 mx-0">
                <div className="col-4 col-md-3 d-flex justify-content-md-center px-3">
                    <a href="/">
                        <img className="image" height="30px" draggable="false" width="auto" src={require('../../../../src/assets/images/conference/logomain.png')} alt="Team Shakti" />
                    </a>
                </div>
                <div className="col-8 d-none d-md-flex justify-content-md-end align-items-center">
                    <nav>
                        ...
                        <Fade delay={300}>
                            <a className="newone" href="/guest_speaker">Speakers</a>
                        </Fade>
                        <Fade delay={400}>
